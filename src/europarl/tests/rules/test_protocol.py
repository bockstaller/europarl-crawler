...
def test_get_url_PdfProtocol(date, expected):
    assert PdfProtocol.use_rule(date) == expected
...
def test_get_url_HtmlProtocol(date, expected):
    assert HtmlProtocol.use_rule(date) == expected
